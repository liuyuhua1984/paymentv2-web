...
public class Snippet {
	 ...
	 * 前缀
	 */
	private static String webName = "payment";//Constant.GoogleAuthName;
	...
	public static void main(String args[]){
		//R2HYMRFHOZG2J4K6 || otpauth://totp/web--duanli?secret=R2HYMRFHOZG2J4K6
//		genSecret("duanli");
		boolean res = auth(404897,"R2HYMRFHOZG2J4K6");
